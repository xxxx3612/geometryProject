...
const problemsData: Record<string, { title: string; description: string; html: string }> = {
  "1": {
    title: "正方体动点求截面距离",
    description: "各棱长均为1的正方体ABCD-A1B1C1D1上，M、N分别是A1B，B1C的中点，求直线MN的长度",
    html: `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<script type="module">
  ...
  "2": {
    title: "正三棱柱中的轨迹问题",
    description: "在正三棱柱AB-A1B1C1中，已知AB=1, D在棱BB1上，且BD=1，则AD与平面AA1C1C所成交的正弦值为？",
    html: `<!DOCTYPE html>
<html>
<head>
    <style>
